...
namespace PrepaidforgeSDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "http://localhost:8080/api-1.0-SNAPSHOT/v1";
        ...
        public Configuration(
            ...
            string basePath = "http://localhost:8080/api-1.0-SNAPSHOT/v1") : this()
        {
        ...
        {
            String report = "C# SDK (PrepaidforgeSDK) Debug Report:\n";
