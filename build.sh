...
${nuget_cmd} install src/PrepaidforgeSDK/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/PrepaidforgeSDK.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/PrepaidforgeSDK.dll \
-recurse:'src/PrepaidforgeSDK/*.cs' \
-doc:bin/PrepaidforgeSDK.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/PrepaidforgeSDK.dll was created successfully"
fi
